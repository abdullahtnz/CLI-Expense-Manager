...
**to DELETE an expense:** delete --id _idnumber_ <br>
**to VIEW all expenses including their ID, description, amount, and date:** list <br>
**to UPDATE any expenses:** update --id _idnumber_ --description _whatever_ / --amount _whatever_ / both, next to each other with same style <br>
